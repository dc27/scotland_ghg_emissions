  ...
  dashboardBody(
    ...
    tagList(
      ...
      navbarPage(
        ...
        tabPanel(title = "Home", value = "home",
                   ...
                   column(
                     ...
                     box(
                       ...
                       tags$div(
                         ...
                         tags$h1("Greenhouse Gas Emissions in Scotland - Path to Net Zero")
                       )
                     )
                   )
                 ),
                 fluidRow(
                   column(
                     4,
                     id = "nav",
                     actionBttn(style = "material-flat",
                                color = "success",
                                inputId = 'goto_emissions_explorer',
                                label = 'Explore Emissions'),
                     tags$br(),
                     actionBttn(style = "material-flat",
                                color = "success",
        ...
        tabPanel(title = "Emissions Explorer", value = "emissions", 
        ...
        # Scottish Government Targets Exploration
        tabPanel(title = "Scottish Government Targets and Progress", value = "targets", 
                 actionButton('return_home_2', 'Home')),
        # 
        tabPanel(title = "Impact of Green Choices", value = "choices", 
