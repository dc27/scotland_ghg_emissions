...
summarised <- group_and_summarise_excluding(ghg_emissions_clean, c("year", "value", "units"))
...
road_traffic %>% 
  ...
  geom_line() +
  geom_point() +
  geom_point(aes(x = target_x,
                 y = (.data[["value"]][.data[[base_var]] == base_value])*base_modifier),
